...
final class TextMasterTest extends \PHPUnit\Framework\TestCase
{
    public function testCountFailure()
    {
        ...
        $uniqueWords = TextMaster::findUniqueWordsOfLength(3, $text);
    ...
    public function testEqualFailure()
    {
        ...
        $this->assertEquals($expectedWords, TextMaster::findUniqueWordsOfLength(3, $text));
    }
}
